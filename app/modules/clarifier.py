...
def check_clarification_needed(
    ...
    logger.info(f"Clarification decision: needs={needs_clarification}, "
...
- ⚠️ **IMPERATIVE COMMAND with missing specifics**: Query starts with action verb commanding you to DO something specific
